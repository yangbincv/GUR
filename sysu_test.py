...
from clustercontrast.evaluators import extract_features_collectbn, extract_features
...
def main_worker(args):
    ...
    # checkpoint = load_checkpoint(osp.join('/dat01/yangbin/cluster-contrast-reid-camera/logs/sysu_all_resnet_pretrain_dualintra2inter2inter_stageall', 'model_best.pth.tar'))
    # checkpoint = load_checkpoint(osp.join('/dat01/chenjun3/cc_plus/logs/sysu_all_resnet_mape_clu', 'model_best.pth.tar'))
